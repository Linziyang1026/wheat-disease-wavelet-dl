...
def main():
    ...
    input_dir = r"D:\workspace\data\wheat\img" # 输入图像的目录
    grayscale_dir = r"D:\workspace\data\wheat\grayimg" # 输出灰度图像的目录
    processed_output_dir = r"D:\workspace\data\wheat\threshold_processed_images" # 输出处理后的图像的目录
    subbands_output_dir = r"D:\workspace\data\wheat\subbands" # 输出子波段的目录
    ...
    # 自动确定最佳聚类数量并找到代表性样本
    representative_samples = find_representative_samples(grayscale_dir)
