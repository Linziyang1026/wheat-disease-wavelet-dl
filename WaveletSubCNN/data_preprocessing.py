...
def main():
    image_folder = r"D:\workspace\pyspace\code\wheat-disease-wavelet-dl\wheatdata\threshold_processed_images"  # 替换为你的原始图像文件夹的实际路径
    ...
    # 定义目标文件夹
    output_base_dir = r"F:\wheat\output_threshold_processed_images"  # 替换为你希望保存划分后数据集的基础路径
